...
/**
  ...
  objet de type (une instance de) http.Server. Cet objet est documenté ici :
...
httpServer.on('request', function (requeteHTTP, reponseHTTP) {
  ...
  /**
    ...
    requête HTTP reçue. Cet objet est documenté ici :
  ...
  **/
  ...
  /**
    ...
    réponse HTTP reçue. Cet objet est documenté ici :
  ...
  **/
  ...
  // On crée une variable qui contient le corps de la réponse.
  ...
  */
  ...
  /**
     A NOTER : Le nombre d'octets correspondant à une chaîne de caractères n'est
     pas égal au nombre de caractères. Exemple
